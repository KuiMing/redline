...
- [todo] 所有奧援卡升到 II 級以上時，必須依各卡面指定地區檢查玩家是否在該地區擁有「最多的組織」，不能只因該地區至少有 1 個己方組織就觸發 II／III 級功能。後續修正需逐張核對卡面指定地區、II／III 級條件及平手時的判定，再補 tier detection regression 與正式 UI proof。（2026-07-31 規則回報）
