...
### P1：軍火庫城鎮的地圖圖示
- [todo] 地圖上的軍火庫城鎮必須常態疊加 🧨 圖示，用來標示該城鎮具備軍火庫能力。
- [todo] 當軍火庫城鎮成為瓦解目標時，目標狀態仍須顯示 💀，不可用 🧨 取代瓦解圖示；必要時同時顯示軍火庫與瓦解狀態。
- [todo] 補上地圖 Browser regression，驗證一般狀態顯示 🧨、瓦解選擇狀態顯示 💀，並確認縮放後圖示仍對齊正確城鎮。
