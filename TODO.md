...
- [done] 大廳陣營選擇與遊戲內「我的陣營」均會列出香港城、臺北、倫敦、卡加利及多倫多的能力、目前根據地、可前移根據地、解鎖事件及遷移後能力切換。
- [done] 事件窗口開啟時，「我的陣營（可前移）」會亮起，並提供四個前移按鈕及維留按鈕。Browser proof **8/8 passed**；單元與 board-action 聚焦回歸 **8/8 passed**；規則 validator **5/5 passed**。
