...
### P1：修正香港根據地遷移用語
- [ ] 將香港根據地事件與 UI 中的「前移」統一改為「遷移」。包含「免費前移根據地」→「免費遷移根據地」、「可前移」→「可遷移」，以及「前移至臺北／倫敦／卡加利／多倫多」→「遷移至臺北／倫敦／卡加利／多倫多」。
- [ ] 將「維留」統一改為「留在」。包含提示文字「亦可維留目前的香港城」→「亦可留在目前的香港城」，以及按鈕「維留香港城」→「留在香港城」。
- [ ] 依截圖逐項檢查分頁名稱、事件標題、提示文字及五個操作按鈕。截圖證據：`docs/records/faction-ui/hong-kong-relocation-wording/playtest-wording-20260816.jpg`。
- [ ] 本項目前只記錄，尚未實作。

### P1：修正「香港抗暴之戰」事件名稱與香港根據地效果
- [done] 正式名稱已統一為事件卡「香港抗暴之戰」；陣營資料、`rules.md`、UI 與 runtime 不再把「香港抗爭之烈」當作有效事件名稱。
- [done] 「香港抗暴之戰」完成結算後，不論任務成功或失敗，香港可在下一回合開始前免費前移一次根據地至臺北、倫敦、卡加利或多倫多；亦可明確選擇維留目前根據地。目的地已有實體組織時不可前移。
...
- [done] S5-1：香港根據地免費前移規則（2026-08-14 依使用者最新裁決修正）。
  - 正式規則：事件卡**香港抗暴之戰**完成結算後（成功或失敗皆算），香港可在下一回合開始前免費前移一次根據地至臺北／倫敦／卡加利／多倫多，亦可維留目前根據地。
  - 赤鱲角機場是另一項「花費 2 次遷移移動香港組織」的規則，不提供付費遷移根據地。舊紀錄把兩者混在一起，現已移除錯誤路徑。
  - 實作：事件結算開啟 `hk_free_base_relocation`；`relocate_hong_kong_base` 只接受免費窗口；新增 `keep_hong_kong_base`；根據地錨定組織與在地能力隨前移切換；目的地已有組織時封鎖。
  - UI：大廳及「我的陣營」列出全部五個根據地與能力；窗口開啟時顯示四個前移按鈕與維留按鈕。
