...
- [done] 專用 Browser proof **17/17 passed**；1,371 種陣營／實際根據地組合 **1,371/1,371 passed**；房主難易度 **8/8 passed**；最後席位紅軍限制 **7/7 passed**；完整 pytest **418/418 passed**。
...
- [done] 整合 Browser proof **17/17 passed**；1,371 種陣營／實際根據地組合 **1,371/1,371 passed**；1280×720 與 1024×768 無裁切。
