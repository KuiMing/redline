...
def run_validation():
    ...
    assert_true(checks, 'ending turn advances to next player event phase', state_next_event['turn_phase'] == 'event' and state_next_event['current_player'] == 'player2', state_next_event)
