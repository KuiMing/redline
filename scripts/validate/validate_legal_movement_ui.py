...
def main():
    ...
    lines = ['# LEGAL MOVEMENT UI VALIDATION', '', f"結果：{summary['passed']}/{summary['total']} PASS", '', '重跑：`uv run --with playwright python scripts/validate/validate_legal_movement_ui.py`', '']
