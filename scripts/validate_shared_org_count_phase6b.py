...
def main():
    ...
    Path('SHARED_ORG_COUNT_PHASE6B_VALIDATION.json').write_text(json.dumps(payload, ensure_ascii=False, indent=2) + '\n', encoding='utf-8')
    Path('SHARED_ORG_COUNT_PHASE6B_VALIDATION.md').write_text(
