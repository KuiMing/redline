...
def list_factions():
    ...
    categories = [
        ...
        {"id": "uyghur", "label": "維吾爾", "mode": "direct", "options": [{
            "id": "uyghur_family",
            "name": "維吾爾",
            "abilities": by_id["uyghur_istanbul"].get("abilities", []),
            "special_rules": ["根據地將於下一步在伊斯坦堡／慕尼黑／華盛頓／阿拉木圖中擇一。"],
            "win_conditions": by_id["uyghur_istanbul"].get("win_conditions", []),
        }]},
        {"id": "tibet", "label": "西藏", "mode": "direct", "options": [{
            "id": "tibet_family",
            "name": "西藏",
            "abilities": by_id["tibet_dharamsala"].get("abilities", []),
            "special_rules": ["根據地將於下一步在達蘭薩拉／德拉敦／哲古宗中擇一。"],
            "win_conditions": by_id["tibet_dharamsala"].get("win_conditions", []),
        }]},
