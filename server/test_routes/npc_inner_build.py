"""Test-only route for the 全國人大召開 inner-build (in-progress) proof state."""
...
class NpcInnerBuildTestRoutes:
    def __init__(self, runtime_provider: Callable[[], GameSetupRuntime]):
        ...
        self.router.add_api_route(
            ...
            self.test_setup_national_people_congress_inner_build_proof,
            methods=["POST"],
        )

    def test_setup_national_people_congress_inner_build_proof(self, payload: dict):
