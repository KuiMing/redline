...
```json
{
  ...
  "screenshots": [
    "docs/records/phase-flow/action-first-phase-20260702_050708/01_initial_action_phase_cards_enabled_buy_disabled.png",
    "docs/records/phase-flow/action-first-phase-20260702_050708/02_purchase_phase_hand_disabled_buy_enabled.png"
  ]
}
```
