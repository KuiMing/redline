...
- test_event_modifiers_are_consumed_by_runtime_rules: passed — {'reduce_cost_buy': ['宣傳家', '資助者'], 'restrict_build_error': 'Current event restricts building organizations', 'ignore_distance_move': {'success': True}}
