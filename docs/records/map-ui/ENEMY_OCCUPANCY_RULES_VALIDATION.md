...
- result: {'error': 'Cannot move into enemy organization'}
...
## direct_build_allows_town_after_red_moved_out — PASS
- result: {'success': True}
- before: {'player_orgs': {'新北': 1}, 'red_orgs': {'新竹': 1}, 'moves_left': 1}
- after: {'player_orgs': {'新北': 2}, 'red_orgs': {'新竹': 1}, 'moves_left': 1}
