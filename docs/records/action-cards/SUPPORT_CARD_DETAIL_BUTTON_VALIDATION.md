...
- ✅ `card_face_shows_all_three_tier_effect_lines` — {"face_text": "III級（臺灣主導）：瓦解己方組織1格內的1個對手組織，並在該城鎮建立1個組織\nII級（東洋/南洋其一主導）：瓦解己方組織1格內的1個對手組織。\nI級（皆未主導）：獲得1點宣傳。"}
- ✅ `card_face_effect_text_is_not_clipped` — {"clientH": 192, "scrollH": 192}
...
- ✅ `red_army_support_card_also_shows_discard_and_action_only` — {"buttons": [{"text": "棄置", "mode": "resource", "disabled": false}, {"text": "行動", "mode": "action", "disabled": false}]}
