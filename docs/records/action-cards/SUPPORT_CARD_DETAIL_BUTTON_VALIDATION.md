...
## Results
- ✅ `support_card_shows_detail_not_resource_button` — {"buttons": [{"text": "詳情", "mode": "detail", "disabled": false}, {"text": "行動", "mode": "action", "disabled": false}]}
...
- ✅ `card_face_already_shows_all_three_tier_effect_lines` — {"face_text": "III級：瓦解己方組織1格內的1個對手組織，並在該城鎮建立1個組織\nII級：瓦解己方組織1格內的1個對手組織。\nI級：獲得1點宣傳。"}
- ✅ `red_army_support_card_also_shows_detail_not_resource` — {"buttons": [{"text": "詳情", "mode": "detail", "disabled": false}, {"text": "行動", "mode": "action", "disabled": false}]}
