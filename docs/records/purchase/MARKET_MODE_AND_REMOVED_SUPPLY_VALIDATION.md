...
|---|---|---|---|
| sample_53 draw pile matches 35-card sampled market deck minus 5 exposed market cards | ❌ | `48` | `30` |
| sample_53 state market mode | ✅ | `"sample_53"` | `"sample_53"` |
| all_cards draw pile exceeds sample_53 sampled market deck after 5 exposed cards | ✅ | `68` | `"> 30"` |
