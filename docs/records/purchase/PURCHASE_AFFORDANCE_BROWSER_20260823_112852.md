  ...
  "checks": [
    {
      ...
      "details": {
        ...
        "meta": "目前：行動｜下一步：結束行動",
        "advance_text": "結束行動",
        "advance_display": "flex",
        "screenshot": "docs/records/purchase/purchase-affordance-browser-20260823_112852/01_initial_action_phase_no_continue_button.png"
      }
    },
    {
      ...
      "details": {
        ...
        "screenshot": "docs/records/purchase/purchase-affordance-browser-20260823_112852/02_action_phase_no_resources_buy_disabled.png"
      }
    },
    {
      ...
      "details": {
        ...
        "action_log_tail": [
          "[Turn 1] Event drawn: 藏印邊境軍事對峙",
          "[Turn 1] hk played 追隨者 as resource",
          "[Turn 1] hk played 追隨者 as resource",
          "[Turn 1] hk played 追隨者 as resource",
          "[Turn 1] hk bought 宣傳家"
        ],
        "screenshot": "docs/records/purchase/purchase-affordance-browser-20260823_112852/03_after_real_click_buy_static_card.png"
      }
    }
  ]
}
