...
- ✅ `clicking_the_skull_only_arms_the_target_and_does_not_dissolve_yet` — {"armed_count": 1, "confirm_btn_state": {"disabled": false, "text": "確認瓦解此組織"}}
- ✅ `confirming_via_sidebar_button_dissolves_enemy_and_sacrifices_own_org` — {"enemy": {}, "mine": {"巴黎": 1}}
