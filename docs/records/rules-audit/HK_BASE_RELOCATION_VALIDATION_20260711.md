...
- PASS relocation_restrictions: checks={"only_four_cities": true, "occupied_destination_blocked": true, "free_window_allows_hk_choice_out_of_turn": true, "non_hk_faction_blocked": true}
