...
## cycle_6_after_advance_to_action_resolve_pending_choices
- resolved: [{'player_id': 'p1', 'choice_type': 'multi_card_choice', 'choice_key': 'event_discard_self', 'index': [0], 'result': {'success': True, 'chosen_cards': ['追隨者']}, 'turn': 2, 'turn_phase': <TurnPhase.ACTION: 'action'>, 'current_player': 'player1'}]

## cycle_6_play_card
- player: player1
- faction: republican
- hand_before: ['追隨者', '樂捐者', '追隨者']
- hand_after: ['樂捐者', '追隨者']
- result: {'success': True}
- resources: {'money': 0, 'propaganda': 0}
- moves_left: 0
...
- player: player2
- faction: red_army
- hand_before: ['樂捐者', '追隨者', '追隨者', '樂捐者', '紅軍奧援']
- hand_after: ['追隨者', '追隨者', '樂捐者', '紅軍奧援']
- result: {'success': True}
- resources: {'money': 0, 'propaganda': 0}
- moves_left: 0
