...
- PASS `narrow_layout_keeps_header_controls_inside_viewport`
- PASS `browser_console_has_no_errors`

- `docs/records/ui-layout/command-header-tabs/command-header-tabs-1280x720.png`
- `docs/records/ui-layout/command-header-tabs/command-header-tabs-1024x768.png`
