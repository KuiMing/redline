...
- PASS: `confirm_returns_to_lobby_with_reopen_button`
- PASS: `reopen_restores_confirmed_selection`
- PASS: `picker_fits_1024x768`
- PASS: `show_strength_uses_requested_wording_and_player_choice_copy`
- PASS: `selected_faction_shows_era_stage_before_confirmation`
- PASS: `updated_manchuria_base_returns_to_lobby`
- PASS: `join_room_auto_opens_picker`
- PASS: `occupied_base_is_disabled_and_server_rejects_race`
