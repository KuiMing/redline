...
- after: {'resources': {'money': 0, 'propaganda': 2}, 'moves_left': 1, 'orgs': {'北京': 2}, 'supply': 2, 'discard': []}
- expected: {'resources': {'money': 0, 'propaganda': 2}, 'moves_left': 1, 'orgs': {'北京': 2}, 'supply_delta': 1}
- rule: 被移除的卡牌直接回到購買區；常設卡移除後對應庫存 +1。內鬥沒有移除效果，正常進棄牌堆。

## 思想家_effect_and_removed_card_destination — PASS
- result: {'success': True}
- before: {'resources': {'money': 0, 'propaganda': 0}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply': 1, 'discard': []}
- after: {'resources': {'money': 0, 'propaganda': 3}, 'moves_left': 3, 'orgs': {'北京': 2}, 'supply': 2, 'discard': []}
- expected: {'resources': {'money': 0, 'propaganda': 3}, 'moves_left': 3, 'orgs': {'北京': 2}, 'supply_delta': 1}
- rule: 被移除的卡牌直接回到購買區；常設卡移除後對應庫存 +1。內鬥沒有移除效果，正常進棄牌堆。

## 資助者_effect_and_removed_card_destination — PASS
- result: {'success': True}
- before: {'resources': {'money': 0, 'propaganda': 0}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply': 1, 'discard': []}
- after: {'resources': {'money': 4, 'propaganda': 2}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply': 2, 'discard': []}
- expected: {'resources': {'money': 4, 'propaganda': 2}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply_delta': 1}
- rule: 被移除的卡牌直接回到購買區；常設卡移除後對應庫存 +1。內鬥沒有移除效果，正常進棄牌堆。

## 資本家_effect_and_removed_card_destination — PASS
- result: {'success': True}
- before: {'resources': {'money': 0, 'propaganda': 0}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply': 1, 'discard': []}
- after: {'resources': {'money': 6, 'propaganda': 3}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply': 2, 'discard': []}
- expected: {'resources': {'money': 6, 'propaganda': 3}, 'moves_left': 0, 'orgs': {'北京': 1}, 'supply_delta': 1}
- rule: 被移除的卡牌直接回到購買區；常設卡移除後對應庫存 +1。內鬥沒有移除效果，正常進棄牌堆。
